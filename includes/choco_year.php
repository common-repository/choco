...
function choco_year($atts) {
    ...
    */
    ...
    $formatedDateString = sprintf($format, date('Y', $mkdate) + $year_diff);
    ...
    */
    ...
    if (is_array($atts) && array_key_exists('id', $atts)) {
        ...
        $id = "choco_year_shortcode";
    }

    if ($classes) {
        $classes = 'class="' . $classes . '"';
    } else {
        $classes = 'class="choco_year"';
    }
...
add_shortcode('choco_year', 'choco\choco_year');
